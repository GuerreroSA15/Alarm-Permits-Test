...
if (!empty($street_num) || !empty($street_name) || !empty($AptUnit) || !empty($Project))
{
	...
	$tsql = "select EMP.PERSONNUM, 
	EMP.PERSONFULLNAME, 
	EMP.SUPERVISORFULLNAME, 
	EMP.HOMELABORLEVELDSC1, 
	DAT.CUSTOMDATA 
	from VP_EMPLOYEE EMP
	left JOIN VP_PERSONCUSTDATA DAT
	on EMP.PERSONNUM = DAT.PERSONNUM 
	where DAT.CUSTOMDEFNAME = 'Job Title'
	and EMP.HOMELABORLEVELNAME1 like '15%'
	and EMP.EMPLOYMENTSTATUS = 'Active'";
